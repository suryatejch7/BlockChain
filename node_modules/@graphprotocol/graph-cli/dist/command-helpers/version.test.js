...
describe('Version Command Helpers', { concurrent: true }, () => {
    ...
    describe('assertManifestApiVersion', () => {
        ...
        describe('With just dataSources', () => {
            test('When all of them are less than minimum apiVersion', async () => {
                vi.spyOn(loadManifestUtils, 'loadManifest').mockImplementation(() => Promise.resolve({
                    dataSources: [
                ...
                await expect(assertManifestApiVersion(fakeManifestPath, minimumApiVersion)).rejects.toThrow(new Error(`The current version of graph-cli can't be used with mappings on apiVersion less than '${minimumApiVersion}'`));
            });
            ...
            test('When none of them are less than minimum apiVersion', async () => {
                ...
                await expect(assertManifestApiVersion(fakeManifestPath, minimumApiVersion)).resolves.toBe(undefined);
            });
        });
    ...
    describe('assertGraphTsVersion', () => {
        ...
        test("When the installed graph-ts version is less than what's supported", async () => {
            ...
            await expect(assertGraphTsVersion(fakeNodeModulesDir, minimumGraphTsVersion)).rejects.toThrow(new Error(`To use this version of the graph-cli you must upgrade the graph-ts dependency to a version greater than or equal to ${minimumGraphTsVersion}
