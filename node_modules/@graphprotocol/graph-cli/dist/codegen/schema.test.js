...
const formatTS = async (code) => await prettier.format(code, { parser: 'typescript', semi: false });
const createSchemaCodeGen = (schema) => new SchemaCodeGenerator(new Schema(schema, graphql.parse(schema), ''));
