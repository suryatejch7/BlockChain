...
async function unpauseCrowdsale() {
    ...
    try {
        showStatusMessage('pauseStatus', 'info', '<div class="loading"></div> Unpausing crowdsale...');
        ...
        showStatusMessage('pauseStatus', 'success', '✅ Crowdsale unpaused successfully!');
        addTransaction('Unpause Crowdsale', 'Crowdsale operations resumed', tx.hash);
        
        await updateUI();
    } catch (error) {
        console.error('Unpause error:', error);
        showStatusMessage('pauseStatus', 'error', '❌ Failed to unpause: ' + error.message);
    }
}
